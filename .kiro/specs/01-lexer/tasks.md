...
This list was rewritten after the P0 audit adjudication. Three tasks that instructed work the requirements did not authorise are gone: NFC normalisation (no normalisation happens at all), currency validation (`AEG-4140`, checker), and the non-lexical limits `AEG-1013`, `1016`, `1017`, `1018` (parser, checker, loader). Two tasks are new: trivia retention and the lexer conformance corpus.

- [ ] **1.1** Define the token kind enumeration and the Token type with span
